...
public class LeadCentralAdapter extends ArrayAdapter<LeadCentralDataClass> {


    private Context context;
    private ArrayList<LeadCentralDataClass> arrayList;

    public LeadCentralAdapter(@NonNull Context context, ArrayList<LeadCentralDataClass> arrays) {
